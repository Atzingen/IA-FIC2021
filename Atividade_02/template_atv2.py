...
def organize_data(file_name):
    ...
    * Utilize pandas como pd
    ...
    array([9.74986214, 5.14024213, 5.86335541, 5.24703444, 8.08797205, 2.29859507, 1.0])
    
    >>> organize_data('data.csv').loc[100].values
    array([9.00177971, 4.42446467, 7.19523579, 5.72467708, 9.79228746, 5.19021883, 1.0])
    '''
    df = None
    ### Seu código inicia aqui ###
